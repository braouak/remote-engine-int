...
rem Commented by TMC build. setmem.bat used insted, called after :Check_JAVA_END label
rem if "%JAVA_MIN_MEM%" == "" (
...
rem  Commented by TMC build END
...
rem setmem.bat script call was added by TMC build
...
:EXECUTE
    set JAVA_OPTS=-Djdk.util.zip.disableZip64ExtraFieldValidation=true %JAVA_OPTS%
